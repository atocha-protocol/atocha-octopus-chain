...
use frame_support::traits::{CurrencyToVote, EitherOfDiverse};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("atocha-chain"),
	authoring_version: 1,
...
parameter_types! {
	pub const TransactionByteFee: Balance = 10_000_000_000;
...
pub type EnsureRootOrHalfCouncilCollective = EitherOfDiverse<
